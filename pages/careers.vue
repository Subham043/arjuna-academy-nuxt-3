      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 col-6">
            <div class="featured-item-two">
              <div class="feature-icon-holder">
                <NuxtImg format="webp" loading="lazy" placeholder="/images/placeholder.webp" src="/images/careers/heartbeat@1x.png" />
          ...
          <div class="col-lg-6 col-6">
            <div class="featured-item-two">
              <div class="feature-icon-holder">
                <NuxtImg format="webp" loading="lazy" placeholder="/images/placeholder.webp" src="/images/careers/teamwork@1x.png" />
                <h3>Inclusion</h3>
              </div>
          ...
          <div class="col-lg-6 col-6">
            <div class="featured-item-two">
              <div class="feature-icon-holder">
                <NuxtImg format="webp" loading="lazy" placeholder="/images/placeholder.webp" src="/images/careers/green-leaf@1x.png" />
          ...
          <div class="col-lg-6 col-6">
            <div class="featured-item-two">
              <div class="feature-icon-holder">
                <NuxtImg format="webp" loading="lazy" placeholder="/images/placeholder.webp" src="/images/careers/respect--1-@1x.png" />
