...
const { data, pending, error, refresh } = await useSSRFetch<{
  test: OnlineTestType
}>(() => API_ROUTES.admission_registration_test + `/${route.params.slug}`, {
  key: 'admission_online_test_detail_' + route.params.slug,
  lazy: true
})
...
const testApplyHandler = async () => {
  ...
  try {
    const response = await useCustomFetch(API_ROUTES.admission_registration_test + `/${route.params.slug}/apply`)
  ...
  <div>
              ...
              <div class="courses-details-sidebar">
                <!-- <div class="price-tag">
                  <h5 class="d-inline m-0">
                    <span v-if="false">&#8377;{{ data.test.amount }}</span><span v-else>Free</span>
                  </h5>
                </div> -->
                <img
                  :src="data.test.image"
                  ...
                  <div class="">
                    <div class="col-lg-12 col-md-12">
                      <div class="d-flex align-items-center">
                        ...
                        <NuxtLink v-else noPrefetch :to="`/admission/online-tests/${data.test.slug}/report`" class="default-btn">
                          View Test Report
                        </NuxtLink>
                      </div>
                    </div>
    ...
    >
      <div class="p-4 py-1">
        ...
        >
          <NuxtLink noPrefetch class="default-btn" :to="`/admission/online-tests/${data.test.slug}/ongoing`">
