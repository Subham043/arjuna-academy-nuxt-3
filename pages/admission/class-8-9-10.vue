...
const onSubmit = handleSubmit(async (values: any, actions: any) => {
  ...
  try {
    ...
    formData.append('class', values.class_no)
    ...
    const response = await useCustomFetch(API_ROUTES.admission_not_puc, {
      method: 'POST',
      body: formData
    })
    ...
    actions.setErrors({
      ...
      class_no: err?.errors?.class?.length > 0 && err?.errors?.class[0],
      percentage: err?.errors?.percentage?.length > 0 && err?.errors?.percentage[0],
                    ...
                    >
                      <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                          <div class="form-group">
                            <CustomElInput name="class_no" placeholder="Class*" />
                          </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                          <div class="form-group">
                            <CustomElInput name="percentage" placeholder="% In Previous Year*" />
                          </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                          <div class="form-group">
