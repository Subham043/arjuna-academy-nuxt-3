export const API_ROUTES = {
  ...
  admission_registration_info: '/api/v1/admission/info',
  admission_registration_repay: '/api/v1/admission/info/repay',
  admission_registration_test: '/api/v1/admission/info/test',
  admission_registration_download: '/api/v1/admission/info/download',
